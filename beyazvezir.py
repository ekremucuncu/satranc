def beyazvezir(x_secilen,y_secilen,secilen_tas,sheet):
    h1=beyazvezir_arka(x_secilen,y_secilen,secilen_tas,sheet)
    h2=beyazvezir_on(x_secilen,y_secilen,secilen_tas,sheet)
    h3=beyazvezir_sol(x_secilen,y_secilen,secilen_tas,sheet)
    h4=beyazvezir_sag(x_secilen,y_secilen,secilen_tas,sheet)
    h5=beyazvezir_sag_yukari(x_secilen,y_secilen,secilen_tas,sheet)
    h6=beyazvezir_sol_yukari(x_secilen,y_secilen,secilen_tas,sheet)
    h7=beyazvezir_sag_asagi(x_secilen,y_secilen,secilen_tas,sheet)
    h8=beyazvezir_sol_asagi(x_secilen,y_secilen,secilen_tas,sheet)
...
def beyazvezir_on(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
...
def beyazvezir_arka(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=2, max_col=2):
        for cell in row:
...
def beyazvezir_sag(x_secilen,y_secilen,secilen_tas,sheet):
    liste=[]
    konum=[]
...
def beyazvezir_sol(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=3, max_col=3):
        for cell in row:
...
def beyazvezir_sag_yukari(x_secilen,y_secilen,secilen_tas,sheet):
    liste=[]
    konum=[]
    for row in sheet.iter_rows(min_row=2,max_row=33,min_col=2,max_col=2):
        for cell in row:
...
def beyazvezir_sol_yukari(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=2, max_col=2):
        for cell in row:
...
def beyazvezir_sag_asagi(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=2, max_col=2):
        for cell in row:
...
def beyazvezir_sol_asagi(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=2, max_col=2):
        for cell in row:
