def beyazfil(x_secilen,y_secilen,secilen_tas,sheet):
    h1=beyazfil_sag_yukari(x_secilen,y_secilen,secilen_tas,sheet)
    h2=beyazfil_sol_yukari(x_secilen,y_secilen,secilen_tas,sheet)
    h3=beyazfil_sag_asagi(x_secilen,y_secilen,secilen_tas,sheet)
    h4=beyazfil_sol_asagi(x_secilen,y_secilen,secilen_tas,sheet)
    geri=h1+h2+h3+h4
...
def beyazfil_sag_yukari(x_secilen,y_secilen,secilen_tas,sheet):
    liste=[]
    konum=[]
...
def beyazfil_sol_yukari(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=2, max_col=2):
        for cell in row:
...
def beyazfil_sag_asagi(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=2, max_col=2):
        for cell in row:
...
def beyazfil_sol_asagi(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=2, max_col=2):
        for cell in row:
