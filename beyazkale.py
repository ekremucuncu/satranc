def beyazkale(x_secilen,y_secilen,secilen_tas,sheet):
    h1=beyazkale_arka(x_secilen,y_secilen,secilen_tas,sheet)
    h2=beyazkale_on(x_secilen,y_secilen,secilen_tas,sheet)
    h3=beyazkale_sol(x_secilen,y_secilen,secilen_tas,sheet)
    h4=beyazkale_sag(x_secilen,y_secilen,secilen_tas,sheet)
    geri=h1+h2+h3+h4
...
def beyazkale_on(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
...
def beyazkale_arka(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=2, max_col=2):
        for cell in row:
...
def beyazkale_sag(x_secilen,y_secilen,secilen_tas,sheet):
    liste=[]
    konum=[]
...
def beyazkale_sol(x_secilen,y_secilen,secilen_tas,sheet):
    liste = []
    konum = []
    for row in sheet.iter_rows(min_row=2, max_row=33, min_col=3, max_col=3):
        for cell in row:
